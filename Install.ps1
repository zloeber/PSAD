# Run this in an administrative PowerShell prompt to install the PSAD PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/zloeber/PSAD/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'PSAD'
$DownloadURL = 'https://github.com/zloeber/PSAD/raw/master/release/PSAD-current.zip'
