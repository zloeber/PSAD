...
```
Get-DSAccountMembership [-DotNotAllowDelegation] [-AllowDelegation] [-UnconstrainedDelegation]
 [-LogOnAfter <DateTime>] [-LogOnBefore <DateTime>] [-NoPasswordRequired] [-PasswordNeverExpires] [-Disabled]
 [-Enabled] [-AdminCount] [-ServiceAccount] [-MustChangePassword] [-Locked] [-Identity <String>]
