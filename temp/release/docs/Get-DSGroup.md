...
```
Get-DSGroup [[-Identity] <String>] [-ComputerName <String>] [-Credential <PSCredential>] [-Limit <Int32>]
 ...
 [-IncludeAllProperties] [-Raw] [-ChangeLogicOrder] [-ModifiedAfter <DateTime>] [-ModifiedBefore <DateTime>]
 [-CreatedAfter <DateTime>] [-CreatedBefore <DateTime>] [-Category <String>] [-AdminCount]
```
